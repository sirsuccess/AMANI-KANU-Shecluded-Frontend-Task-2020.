        ...
        <div className="card-section">
          <div className="card bg-secondary">
            <div className="card-img">
              <img
                src="https://encrypted-tbn0.gstatic.com/images?q=tbn%3AANd9GcQQADBXDSDLy8rbBCLAERG4gdDUMIXTQS82bob6a-cFXGYoQK-g"
                alt="Veterinarian Service"
              />
          ...
          <div className="card bg-secondary">
            <div className="card-img">
              <img
                src="http://www.africanindustries.com/images/chemical.jpg"
                alt="Chemical"
              />
          ...
          <div className="card bg-secondary">
            <div className="card-img">
              <img
                src="http://www.africanindustries.com/images/Glass.jpg"
                alt="Glass"
              />
